...
symb_15N_pac_plot <- ggplot(data = Symb_plots %>% filter(Species == "Pocillopora acuta symbiont"), aes(y = del15N, x = pc1, color = pc1, shape = Genotype)) +
  geom_point() +
  scale_color_viridis()+
#  scale_x_discrete(labels = custom_labels) + 
...
symb_15N_pru_plot <- ggplot(data = Symb_plots %>% filter(Species == "Porites rus symbiont"), aes(y = del15N, x = pc1, color = pc1, shape = Genotype)) +
  geom_point() +
  scale_color_viridis()+
#  scale_x_discrete(labels = custom_labels) + 
